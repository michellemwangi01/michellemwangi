...
const About = () => {
  return (
    <div
      id="whoamI"
      className="h-100 text-geay-700 bg-white justify-evenly align-middle"
    >
      ...
      <div>
        <div className="flex w-5/6 m-auto justify-center my-16  flex-wrap md:flex-row flex-col">
          ...
          <div className="  w-2/3 my-4 text-center m-auto">
            <div className="my-6">
              <div
                data-aos="fade-right"
                className="bg-red-200 p-2 py-4 m-2 my-4 rounded-xl text-xl "
              >
                <p>
